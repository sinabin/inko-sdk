...
const releasePackage = {
  ...
  version,
  description: 'Self-hosted PDF annotation SDK: multi-reviewer overlays, resumable editing, text search, and AcroForm on PDF.js. Review state returns as canvasData for host-managed storage instead of rewriting the PDF.',
