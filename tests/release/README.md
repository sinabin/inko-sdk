...
```powershell
node tests/release/verify-installed-tarball.mjs C:\path\to\inko-pdf-sdk-1.2.0.tgz
```
...
```powershell
node tests/release/verify-installed-tarball.mjs C:\path\to\inko-pdf-sdk-1.2.0.tgz --expect-public
```
